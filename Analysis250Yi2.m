...
yi = audioread('./yi2_48khz_RMSadjusted.wav');
...
[subjs,datafilepathBlockOne,datafilepathBlockTwo] = FFRsplitBiologic('./Mandarin_data/Yi2'); % function input: study folder path  
...
%%
Yi250data = DataAnalysis250Yi(subjs,ResampledFilteredYi250,Fs250,L250,Prestim,PrestimWindow,EntireResponse);
